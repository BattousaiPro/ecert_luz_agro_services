...
export class SectorService {
    ...
    async new(reqNew: SectorDto): Promise<GenericResponse> {
    ...
    async edit(reqEdit: SectorDto, codigo: number): Promise<GenericResponse> {
    ...
    private getObjectEdit(request: SectorDto, elementToEdit: Sector): Sector {
